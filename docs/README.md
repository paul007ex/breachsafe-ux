...
The packaged `enxemble` image is the current shipped reference image; for what that specific
...
- [Architecture decision records](adr/): the settled decisions (0001 to 0003).
