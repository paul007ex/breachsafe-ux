...
BRAND = {
    ...
    "repo": "https://github.com/breachsafe/breachsafe-enxemble",
...
CSS = (
    ...
    ".gradio-container button.bs-test-connection,.gradio-container .bs-test-connection button{"
    "background:#16a34a;color:#fff;border-color:#16a34a}"
    ".gradio-container button.bs-test-connection:hover,.gradio-container .bs-test-connection button:hover{"
    ...
    "border-color:#64748b!important;box-shadow:0 0 0 1px #64748b!important}"
    ".gradio-container .bs-endpoint-row{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr);"
    "gap:16px;align-items:start}"
    ".gradio-container .bs-endpoint-row>*{min-width:0}"
    "@media(max-width:640px){.gradio-container .bs-endpoint-row{grid-template-columns:1fr}}"
